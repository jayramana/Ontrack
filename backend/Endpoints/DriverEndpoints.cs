...
//         // Add this to your existing DriverEndpoints.cs
// // Update the /driver/orders/today/full endpoint
...
// // Also update /driver/route/optimized endpoint
...
public static class DriverEndpoints
{
    public static void MapDriverEndpoints(this IEndpointRouteBuilder app)
    {
            ...
            GeofenceService geofenceService) =>
        {
            ...
            // Notify Logistics Hub (Live Tracking)
            await hubContext.Clients.All.SendAsync("ReceiveDriverLocation", new
            {
                driverId,
                update.Latitude,
