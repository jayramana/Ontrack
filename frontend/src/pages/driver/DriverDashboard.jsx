...
// // //     //         // 🆕 LISTEN FOR RESCHEDULE NOTIFICATIONS
// // //     //         connection.on("OrderRescheduled", (data) => {
// // //     //             console.log("🔔 Order Rescheduled:", data);
// // //     //             setRescheduleInfo(data);
// // //     //             setShowRescheduleAlert(true);
...
// // //     //         // 🆕 LISTEN FOR ROAD ISSUE ALERTS
// // //     //         connection.on("RoadIssueAlert", (data) => {
// // //     //             console.log("⚠️ Road Issue Alert:", data);
// // //     //             setRoadIssueInfo(data);
// // //     //             setShowRoadIssueAlert(true);
// // //     //             fetchOptimizedRoute(); // Auto-refresh route
// // //     //         });
...
// // //             console.log("⚠️ SignalR already initialized. Skipping setup.");
// // //             return;
// // //         }
...
// // //         console.log("✅ Driver SignalR Groups Joined");

// // //         // Save global connection to prevent duplicates
...
// // //     try {
// // //         const res = await api.get("/driver/route/optimized");
// // //         setOptimizedRoute(res.data.stops || []);
// // //     } catch (error) {
// // //         console.error("Error fetching route:", error);
// // //     }
// // // };
...
// // //                     {/* 🆕 AI PRIORITY BADGE */}
// // //                     {order.aiPriority && (
// // //                         <div className={`text-xs px-2 py-1 rounded-full font-bold ${getPriorityBadgeColor(order.aiPriority)}`}>
// // //                             AI-P{order.aiPriority}
// // //                         </div>
// // //                     )}
...
// // //                                     New Date: {new Date(rescheduleInfo.newDate).toLocaleString()}
// // //                                 </p>
// // //                                 {rescheduleInfo.aiPriority && (
// // //                                     <p className="text-sm text-orange-700 font-bold">
// // //                                         AI Priority: {rescheduleInfo.aiPriority}/5
// // //                                     </p>
// // //                                 )}
// // //                                 {rescheduleInfo.reason && (
// // //                                     <p className="text-sm text-orange-700 mt-1">
...
// // //                                     <strong>Type:</strong> {roadIssueInfo.issueType}
// // //                                 </p>
// // //                                 <p className="text-sm text-red-700">
// // //                                     <strong>Severity:</strong> {roadIssueInfo.severity}
// // //                                 </p>
// // //                                 <p className="text-sm text-red-700">
// // //                                     {roadIssueInfo.description}
// // //                                 </p>
// // //                                 <p className="text-sm text-red-700 mt-1">
// // //                                     Reported by: {roadIssueInfo.reportedBy}
// // //                                 </p>
// // //                                 <p className="text-sm text-red-600 font-semibold mt-2">
// // //                                     🔄 Your route has been automatically re-optimized
// // //                                 </p>
// // //                             </div>
// // //                             <button
...
// //                 setShowRescheduleAlert(true);
// //                 // Refresh data safely
// //                 fetchTodaysOrders().catch(e => console.error("fetch orders after reschedule failed", e));
// //                 fetchOptimizedRoute().catch(e => console.warn("fetch route after reschedule failed", e));
// //             });

// //             // 🆕 LISTEN FOR ROAD ISSUE ALERTS (broadcast from Admin)
// //             connection.on("RoadIssueAlert", (data) => {
// //                 console.log("⚠️ Road Issue Alert:", data);
// //                 setRoadIssueInfo(data);
// //                 setShowRoadIssueAlert(true);

// //                 // refresh optimized route (safe)
// //                 fetchOptimizedRoute().catch(err => {
// //                     // 403 might occur if token/claims are still not correct; backend fix should solve it
// //                     console.warn("Error fetching optimized route after road issue:", err);
// //                 });
// //             });
...
// //             // make sure user exists and has an id before invoking
// //             const userId = Number(user?.userId);
// //             if (userId && !Number.isNaN(userId)) {
// //                 // join groups for this driver
// //                 await connection.invoke("JoinDriverRouteGroup", userId);
// //                 await connection.invoke("JoinDriverGroup", userId);

// //                 // join global broadcast group so driver receives road issue alerts
// //                 await connection.invoke("JoinDriverBroadcastGroup");
// //                 console.log("✅ Joined driver groups and broadcast group");
// //             } else {
// //                 console.warn("DriverDashboard: user id not available for joining groups yet");
// //             }
// //         } catch (error) {
// //             console.error("SignalR Error:", error);
// //         }
...
// //     useEffect(() => {
// //         // Setup signalR but only after user is available
// //         setupSignalR();
...
// //             setOptimizedRoute(res.data);
// //         } catch (error) {
// //             // keep UI stable if backend returns 403/401 while token/claims are being resolved
// //             console.error("Error fetching route:", error);
// //             throw error;
// //         }
// //     };
...
// //                                 </p>
// //                                 <p className="text-sm text-red-700">
// //                                     <strong>Severity:</strong> {roadIssueInfo.severity || 'Unknown'}
// //                                 </p>
// //                                 <p className="text-sm text-red-700">
// //                                     {roadIssueInfo.description}
// //                                 </p>
// //                                 <p className="text-sm text-red-700 mt-1">
// //                                     Reported by: {roadIssueInfo.reportedBy || roadIssueInfo.driverName || 'Unknown'}
// //                                 </p>
// //                                 <p className="text-sm text-red-600 font-semibold mt-2">
// //                                     🔄 Your route has been automatically re-optimized
// //                                 </p>
...
// //                 {/* --- Road issues box (also visible below stats) --- */}
// //                 {roadIssueInfo && (
// //                     <div className="bg-white rounded-lg shadow p-4 mb-6">
// //                         <h4 className="font-semibold text-red-700">Road Issues Near You</h4>
// //                         <p className="text-sm text-gray-600">
// //                             {roadIssueInfo.issueType} — {roadIssueInfo.description}
// //                         </p>
// //                         <p className="text-xs text-gray-500 mt-1">
// //                             {roadIssueInfo.latitude}, {roadIssueInfo.longitude}
// //                         </p>
// //                     </div>
// //                 )}
...
//             // Route updates from server (admin re-optimization)
//             connection.on("ReceiveRouteUpdate", (routeData) => {
//                 console.log("📡 New Route Update:", routeData);
//                 setRoute(routeData);
//                 setOptimizedRoute(routeData.stops || []);
...
//                 setShowRescheduleAlert(true);
//                 fetchTodaysOrders();
//                 // No need to call optimized route here; it will usually be sent via ReceiveRouteUpdate
//             });

//             // Road issue alert broadcasted by admin
//             connection.on("RoadIssueAlert", (data) => {
//                 console.log("⚠️ Road Issue Alert:", data);
//                 setRoadIssueInfo(data);
//                 setShowRoadIssueAlert(true);
...
//                 // IMPORTANT:
//                 // We do NOT call /driver/route/optimized here anymore
//                 // because that was causing 403 spam.
//                 // Route updates should come via "ReceiveRouteUpdate".
//             });
...
//                     {order.rescheduleReason && (
//                         <div>
//                             <strong>Why:</strong> {order.rescheduleReason}
//                         </div>
//                     )}
//                 </div>
//             )}
...
//                                 <p className="text-sm text-orange-700">
//                                     New Date:{" "}
//                                     {new Date(rescheduleInfo.newDate).toLocaleString()}
//                                 </p>
//                                 {rescheduleInfo.aiPriority && (
//                                     <p className="text-sm text-orange-700 font-bold">
//                                         AI Priority: {rescheduleInfo.aiPriority}/5
...
const DriverDashboard = () => {
    ...
    // Navigate to road issue reporting page
    const reportIssue = () => {
