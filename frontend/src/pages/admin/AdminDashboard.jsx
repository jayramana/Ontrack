          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-6 mb-8">
            {[
              ...
              <div
                key={i}
                onClick={c.onClick}
                className={`p-6 bg-white rounded-xl shadow border cursor-pointer transition hover:shadow-lg ${
                  c.highlight ? "border-red-300" : c.asrHighlight ? "border-purple-300" : "border-[#e6d8c9]"
                }`}
              >
                <div className="flex justify-between">
                  <div>
                    ...
                    <p
                      className={`text-3xl font-bold ${
                        c.highlight ? "text-red-600" : c.asrHighlight ? "text-purple-600" : "text-[#351c15]"
                      }`}
                    >
                      {c.value}
                    </p>
