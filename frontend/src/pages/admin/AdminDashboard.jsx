            ...
            <div className="bg-[#141922] p-1 rounded-xl flex gap-1 border border-white/5 shadow-sm">
              {["1W", "1M", "3M", "1Y"].map((filter) => (
                <button
                  ...
                  className={`px-4 py-1.5 rounded-lg text-xs font-bold transition-all ${dateFilter === filter
        ...
        <div className="p-8 grid grid-cols-1 md:grid-cols-5 gap-6">
          {[
            ...
            <div
              ...
              className={`bg-linear-to-br from-[#1a1f29] to-[#0f141c] p-6 rounded-xl shadow border border-[#1f2937] flex justify-between items-center ${item.onClick ? "cursor-pointer hover:border-gray-500 transition-colors" : ""
                }`}
            >
              <div>
                    ...
                    assignedOrders.map(o => (
                      ...
                      >
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <span className={`text-xs px-2 py-1 rounded font-bold ${o.status === "Delivered" ? "bg-emerald-500/20 text-emerald-500" : "bg-blue-500/20 text-blue-500"
                            }`}>
