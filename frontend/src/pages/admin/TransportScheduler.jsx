    ...
    <div className="min-h-screen flex bg-[#f8f4ef]">
      ...
      <div className="flex-1 px-8 py-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {showScheduleForm && (
            <div className="bg-white border border-[#e6d8c9] shadow rounded-xl p-6 mb-8">
              <h3 className="text-lg font-bold text-[#351c15] mb-4">
                Schedule New Transport
              </h3>

              <form className="grid grid-cols-3 gap-4" onSubmit={handleManualSchedule}>
                {/* Origin */}
                <div>
                  <label className="block text-sm text-[#351c15] font-medium mb-2">
                    Origin Warehouse
                  </label>
                  <select
                    className="w-full p-3 border border-[#d4c7b9] rounded-lg outline-none focus:ring-2 focus:ring-[#ffb500]"
                    value={scheduleData.originWarehouseId}
                    onChange={(e) =>
                      setScheduleData({
                        ...scheduleData,
                        originWarehouseId: parseInt(e.target.value),
                      })
                    }
                    required
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setScheduleData({
                        ...scheduleData,
                        minOrderCount: parseInt(e.target.value),
                      })
                    }
                  />
                </div>
                ...
                <div className="col-span-3 flex gap-3 mt-2">
                  <button
                    type="submit"
                    className="px-5 py-2 bg-[#351c15] text-white rounded-lg hover:bg-[#2b140f]"
                  >
                    Schedule Transport
                  </button>
