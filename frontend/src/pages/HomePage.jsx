export default function HomePage() {
  return (
    <div className="w-full font-sans bg-[#0b0f14] text-slate-100">
      ...
      <nav className="fixed top-0 left-0 w-full bg-[#0b0f14]/80 backdrop-blur border-b border-white/10 z-50">
        <div className="max-w-7xl mx-auto px-10 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <button className="px-4 py-2 rounded-lg text-slate-300 hover:bg-white/10 transition">
              Login
            </button>
            <button className="px-4 py-2 bg-[#ff8a3d] text-black rounded-lg font-bold hover:opacity-90 transition">
              Sign Up
            </button>
          </div>
      ...
      {/* ================= HERO ================= */}
      <section className="relative min-h-screen pt-28 flex items-center px-10
        bg-gradient-to-br from-[#242c3a] via-[#141a24] to-[#0b0f14]">
        ...
        <div className="relative max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="mt-6 text-slate-400 max-w-lg">
              ...
              intelligent routing, and reliable delivery solutions to keep
              your shipments always on track.
            </p>
          </div>
