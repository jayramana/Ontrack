      ...
      <nav className="fixed top-0 left-0 w-full bg-[#0b0f14]/80 backdrop-blur border-b border-white/10 z-50">
        <div className="max-w-7xl mx-auto px-10 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-4">
            <Link to="/login" className="px-4 py-2 rounded-lg text-slate-300 hover:bg-white/10 transition">
              Login
            </Link>
            <Link to="/signup" className="px-4 py-2 bg-[#ff8a3d] text-black rounded-lg font-bold hover:opacity-90 transition">
              Sign Up
            </Link>
          </div>
